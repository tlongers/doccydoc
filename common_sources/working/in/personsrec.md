...
## Person record title area {#person_record_anatomy_titlearea}
...
## Person record content sidebar {#person_record_anatomy_contentsidebar}
...
## Person "Last Seen As" {#person_record_anatomy_last_seen_as}
 ...
 * [Person: Organization](/en/datamodel/persons.md#person_organization_name)
...
## Person memberships {#person_record_anatomy_memberships}
...
## Person chain of command {#person_record_anatomy_chain_of_command}
...
## Person superiors {#person_record_anatomy_superiors}
...
## Person subordinates {#person_record_anatomy_subordinates}
...
## Person record changelog {#person_record_anotomy_changelog}
